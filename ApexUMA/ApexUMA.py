import ApexUMA.utility as utility
import re 
import logging
import numpy as np 
...
class  UnitCellDesign:
    ...
    def make_unit_cell_library(self,show_plot=False,file=None):       
...
class  LensDesign:
    ...
    def make_lens_geometry(self,radius_zemax, phase_zemax, radius_unitcell, phase_unitcell, idealphase= False, show_lens= False):
        ...
        np.savetxt(current_directory+ '//ApexUMA//lensgeom.txt', data, delimiter=",")
...
class FullLensSim:
    ...
    def run_fdtd(self, xcoord,ycoord, pillar_radius):
        ...
        lens_geometry_file_name=  current_directory+ '//ApexUMA//lensgeom.txt'
        ...
        fdtd.save(current_directory+ "\\ApexUMA\\lumerical_full_lens_test")
        fdtd.run()
